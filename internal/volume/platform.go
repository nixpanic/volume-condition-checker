...
// deployment. Different platforms use different directories ans paths to
...
// GetPlatform retuns the object with utility functions for the current running
// variant of Kubernetes.
func GetPlatform() Platform {
	// TODO: detect other platforms that use different paths (microk8s?)
...
// resides. The volume is mounted on a directory calls "mount".
//
// TODO: blockmode
